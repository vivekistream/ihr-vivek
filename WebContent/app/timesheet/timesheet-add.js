...
.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/addTimesheet', {
    templateUrl: 'app/timesheet/timesheet-add.html',
    controller: 'AddTimesheetCtrl'
  });
}])

.controller('AddTimesheetCtrl', ['$scope', 'TimesheetService', 'MasterEntityService', function($scope, TimesheetService, MasterEntityService) {
